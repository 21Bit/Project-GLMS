...
@push('css')
	<link href="/back-end/plugins/nvd3/nvd3.min.css" rel="stylesheet" />
	<link href="/back-end/plugins/jquery-jvectormap/jquery-jvectormap.min.css" rel="stylesheet" />
	<link href="/back-end/plugins/bootstrap-calendar/css/bootstrap_calendar.css" rel="stylesheet" />
	<link href="/back-end/plugins/gritter/css/jquery.gritter.css" rel="stylesheet" />
@endpush
				...
				<div class="panel-body bg-silver">
					<div class="chats" data-scrollbar="true" data-height="225px">
						<div class="left">
							...
							<a href="javascript:;" class="image"><img alt="" src="../back-end/img/user/user-12.jpg" /></a>
							<div class="message">
						...
						<div class="right">
							...
							<a href="javascript:;" class="image"><img alt="" src="../back-end/img/user/user-13.jpg" /></a>
							<div class="message">
						...
						<div class="left">
							...
							<a href="javascript:;" class="image"><img alt="" src="../back-end/img/user/user-10.jpg" /></a>
							<div class="message">
						...
						<div class="left">
							...
							<a href="javascript:;" class="image"><img alt="" src="../back-end/img/user/user-14.jpg" /></a>
							<div class="message">
		...
		<div class="col-lg-4">
			...
			<div class="panel panel-inverse" data-sortable-id="index-4">
				...
				<ul class="registered-users-list clearfix">
					<li>
						<a href="javascript:;"><img src="../back-end/img/user/user-5.jpg" alt="" /></a>
					...
					<li>
						<a href="javascript:;"><img src="../back-end/img/user/user-3.jpg" alt="" /></a>
						<h4 class="username text-ellipsis">
							Ancient Caviar
							<small>Korean</small>
						</h4>
					...
					<li>
						<a href="javascript:;"><img src="../back-end/img/user/user-1.jpg" alt="" /></a>
						<h4 class="username text-ellipsis">
							Marble Lungs
							<small>Indian</small>
						</h4>
					...
					<li>
						<a href="javascript:;"><img src="../back-end/img/user/user-8.jpg" alt="" /></a>
						<h4 class="username text-ellipsis">
							Blank Bloke
					...
					<li>
						<a href="javascript:;"><img src="../back-end/img/user/user-2.jpg" alt="" /></a>
						<h4 class="username text-ellipsis">
							Hip Sculling
							<small>Cuban</small>
						</h4>
					...
					<li>
						<a href="javascript:;"><img src="../back-end/img/user/user-6.jpg" alt="" /></a>
						<h4 class="username text-ellipsis">
							Flat Moon
					...
					<li>
						<a href="javascript:;"><img src="../back-end/img/user/user-4.jpg" alt="" /></a>
						<h4 class="username text-ellipsis">
							Packed Puffs
					...
					<li>
						<a href="javascript:;"><img src="../back-end/img/user/user-9.jpg" alt="" /></a>
						<h4 class="username text-ellipsis">
							Clay Hike
							<small>Swedish</small>
						</h4>
...
@push('scripts')
	<script src="/back-end/plugins/nvd3/nvd3.min.js"></script>
	<script src="/back-end/plugins/jquery-jvectormap/jquery-jvectormap.min.js"></script>
	<script src="/back-end/plugins/jquery-jvectormap/jquery-jvectormap-world-merc-en.js"></script>
	<script src="/back-end/plugins/bootstrap-calendar/js/bootstrap_calendar.min.js"></script>
	<script src="/back-end/plugins/gritter/js/jquery.gritter.js"></script>
	<script src="/back-end/js/demo/dashboard-v2.js"></script>
	<script>
