...
@section('content')
    ...
    <!-- begin row -->
    <form action="{{ route("back-end.blog.update" , $blog->id) }}" method="post">
        {{ csrf_field() }}
        {{ method_field('PUT') }}
        <div class="row">
            <div class="col-lg-8">
                    ...
                    <div class="panel-body">
                        <form action="{{route('back-end.book.store')}}" method="post">
                            ...
                            <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="title" value="{{ $blog->title }}" class="form-control rounded-0" required>
                                @if ($errors->has('title'))
                ...
                <div class="panel panel-inverse ">
                    ...
                    <p class="mb-3">
                        ...
                        <select name="is_published" class="form-control rounded-0">
                            ...
                            <option value="0" @if($blog->is_published) == 0 ) selected @endif>Draft</option>
                        </select>
                    </p>
                    <p>
