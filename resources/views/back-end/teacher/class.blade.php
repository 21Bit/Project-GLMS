    ...
    <div class="profile">
        <div class="profile-header">
            ...
            <ul class="profile-header-tab nav nav-tabs">
                <li class="nav-item"><a href="{{ route('back-end.teacher.show', $teacher->id) }}" class="nav-link"><i class="fa fa-list"></i> Slots</a></li>
                <li class="nav-item"><a href="{{ route('back-end.teacher.show.class', $teacher->id) }}" class="nav-link active"><i class="fa fa-calendar"></i> Class</a></li>
...
@endsection
@push('scripts')
	<script src="/back-end/plugins/datatables/js/jquery.dataTables.js"></script>
	<script src="/back-end/plugins/datatables/js/dataTables.bootstrap4.js"></script>
	<script src="/back-end/plugins/datatables/js/fixedHeader/dataTables.fixedHeader.js"></script>
	<script src="/back-end/plugins/datatables/js/responsive/dataTables.responsive.js"></script>
	<script src="/back-end/plugins/datatables/js/responsive/responsive.bootstrap4.js"></script>
    {!! $html->scripts() !!}
