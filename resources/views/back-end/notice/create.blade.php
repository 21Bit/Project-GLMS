...
@section('content')
	...
	<ol class="breadcrumb pull-right">
		...
		<li class="breadcrumb-item"><a href="{{ route("back-end.notice.index") }}">Notice</a></li>
    ...
    <!-- begin row -->
    <form action="{{ route("back-end.notice.store") }}" method="post">
        {{ csrf_field() }}
        <div class="row">
            <div class="col-lg-8">
                <!-- begin panel -->
