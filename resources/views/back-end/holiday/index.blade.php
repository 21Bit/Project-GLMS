		...
		<div class="col-lg-12">
			<div class="panel panel-inverse">
				<div class="panel-heading pb-0 mb-3">
					...
					<a href="{{ route("back-end.holiday.create") }}" id="openHolidaForm" title='Add new book' class="btn btn-sm text-white h3"><i class="fa fa-plus"></i></a>
				...
				<div class="panel-body">
					<form action="{{ route('back-end.holiday.multidelete') }}" id="datatable-form" method="post">
						{{ csrf_field() }}
						{!! $html->table() !!}
					</form>
				</div>
