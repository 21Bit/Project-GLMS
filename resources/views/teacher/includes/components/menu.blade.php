      ...
      <ul class="navbar-nav">
            ...
            <a class="dropdown-item" href="#">
              ...
              <div class="d-flex">
                <div style="width:36px;" class="pr-1">
                  <img
                    src="http://127.0.0.1:8000/images/placeholders/male-sm.png"
                    alt=""
                ...
                <div>
                  <b>Jofie Bernas</b> <br />
                  Cancel his class on June 24, 2018
                </div>
              </div>
            </a>
            <a class="dropdown-item" href="#">
              ...
              <div class="d-flex">
                ...
                <div>
                  <b>Jofie Bernas</b> <br />
                  has Avail your Slot on June 29, 2018
                </div>
              </div>
            </a>
        ...
        <li class="nav-item dropdown">
          ...
          >
            ...
            <a
              class="dropdown-item"
              href="{{ route('teacher.profile.changepassword') }}"
              >Change Password</a
            >
            <a
              class="dropdown-item"
