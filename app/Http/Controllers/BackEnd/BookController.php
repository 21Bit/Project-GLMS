...
class BookController extends Controller
{
    public function index(Builder $builder)
    {
         if (request()->ajax()) {
            ...
            return DataTables::of($books)
                ->addColumn('action', function ($book) {
                    return '<a href="' . route('back-end.book.show', $book->id) . '" class="mr-2" ><i class="fa fa-eye"></i> View</a>
                    <a href="' . route('back-end.book.edit', $book->id) . '"><i class="fa fa-edit"></i> Edit</a>
                    ';
                })
                ...
                ->addColumn('pages', function ($book) {
                    return $book->starting . "-" . $book->pageCount();
                })
        ...
        $deleteAllModal = true;
        return view('back-end.book.index', compact('html', 'deleteAllModal'));
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('back-end.book.index')->with('message', "Saved");
    }
    ...
    {
        $book = Book::find($id);
        return view('back-end.book.show', compact('book'));
    }
    ...
    {
        $book = Book::find($id);
        return view('back-end.book.edit', compact('book'));
    }
    ...
    public function update(Request $request, $id)
    {
       ...
       $book->pages()->delete();
        ...
        return redirect()->route('back-end.book.index')->with('message', 'Updated');
    }
